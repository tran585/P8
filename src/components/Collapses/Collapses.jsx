...
function Collapses({ title, description }) {
  ...
  useEffect(() => {
    ...
    if (test !== null && test.scrollHeight !== 0) {
      ...
      newArray.push(
        newArray[newArray.length - 1] === numberElements
          ? numberElements + 1
          : numberElements
      )
  ...
  return (
    <React.Fragment>
      <div className="collapses-bar">
        ...
        <img
          style={{
            ...
            transition: isOpen ? 'all 250ms' : 'all 250ms',
          }}
      ...
      <div
        ...
        className={isOpen ? 'collapse-activated' : 'collapse'}>
        <p
          style={{
          ...
          ref={tagColl}
          className={isOpen ? 'tag-collapses-activated' : 'tag-collapses'}>
          {description}
        </p>
      </div>
    </React.Fragment>
